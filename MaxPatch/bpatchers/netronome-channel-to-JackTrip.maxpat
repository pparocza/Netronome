...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.416764000000285, 2.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 496.416764000000285, 34.0, 101.0, 18.641745448116467 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 528.416764000000285, 2.0, 56.0, 22.0 ],
					"restore" : 					{
						"NTM_channel_input" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.416764000000285, 74.0, 239.0, 22.0 ],
					"text" : "r to-JackTrip_buffer_#0_playback_progress"
				}
...
, 																							{
																								"box" : 																								{
																									...
																									"patching_rect" : [ 2.5, 47.0, 165.0, 22.0 ],
																									"text" : "buffer~ to-JackTrip_buffer_#0"
																								}
...
, 																			{
																				"box" : 																				{
																					...
																					"numoutlets" : 1,
																					"outlettype" : [ "signal" ],
																					"patching_rect" : [ 3.0, 97.0, 169.0, 22.0 ],
																					"text" : "record~ to-JackTrip_buffer_#0"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"patching_rect" : [ 277.0, 167.176178999999991, 56.0, 22.0 ],
																					"sig" : 0.0
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"numinlets" : 1,
																					"numoutlets" : 0,
																					"patching_rect" : [ 314.0, 195.0, 241.0, 22.0 ],
																					"text" : "s to-JackTrip_buffer_#0_playback_progress"
																				}
...
, 																			{
																				"box" : 																				{
																					...
																					"patching_rect" : [ 111.0, 143.176178999999991, 185.0, 22.0 ],
																					"text" : "groove~ to-JackTrip_buffer_#0"
																				}
...
,
					"patching_rect" : [ 341.416764000000285, 2.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.416764000000285, 50.000000051883717, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 341.416764000000285, 26.000000051883717, 117.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.416764000000285, 26.0, 66.0, 22.0 ],
					"text" : "s #0-io_list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.416764000000285, 74.0, 199.0, 22.0 ],
					"text" : "loadmess set to-JackTrip_buffer_#0"
				}

			}
, 			{
				"box" : 				{
					"buffername" : "JackTrip-input_buffer-#0",
					"id" : "obj-18",
					"maxclass" : "waveform~",
					"numinlets" : 5,
					"numoutlets" : 6,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 462.416764000000285, 2.0, 32.0, 46.000000051883717 ],
					"presentation" : 1,
